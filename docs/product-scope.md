...
| 16–18          | File/image attachments, paste/drop                                                                             | Retain. The composer paperclip opens the file picker directly; no Add context dialog. Image input is not image generation.                                                         |
| 19             | URL attachments for agent context                                                                              | Enter URLs in the prompt; no separate reference picker or website embed.                                                                                                           |
