...
| 116–117        | Command palette and customizable shortcuts                                                                     | Keep click/touch search and actions. App keyboard shortcuts and shortcut settings are disabled for now.                                         |
