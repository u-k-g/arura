...
| 116–117        | Command palette and customizable shortcuts                                                                     | Keep click/touch search and actions. Only the composer Command+Enter behavior below is enabled; other app shortcuts and shortcut settings remain disabled. |
