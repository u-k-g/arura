...
Official regular SVGs from
[Iconoir](https://github.com/iconoir-icons/iconoir/tree/d7dfa4d0341df0670bfed9fc24221c9d7ef2112e),
distributed under the accompanying MIT license. Read when adding or updating
icons; keep this family consistent.

Files ending in `-solid.svg` come from the same revision's solid set; the suffix
keeps them distinct from regular variants.
