  ...
  async fn() {
    ...
    try {
      ...
      await a
        .getByRole("button", { name: "Models & providers", exact: true })
        .click();
      await a.getByText("Customize model list", { exact: true }).click();
      await a
        .getByRole("checkbox", {
      ...
      await b
        .getByRole("button", { name: "Models & providers", exact: true })
        .click();
      await b.getByText("Customize model list", { exact: true }).click();
      await expect(
      ...
      await a.getByRole("button", { name: "Artifacts", exact: true }).click();
      await expect(
